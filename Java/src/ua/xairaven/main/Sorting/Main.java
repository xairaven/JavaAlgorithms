...
public class Main {
    public static void main(String[] args) {
        String rawFile = "Java/res/txt_files/32Kints.txt";
        String resFolder = "Java/src/xairaven/ua/main/Sorting/result/";
    ...
    private static void description(String sort) {
        ...
        System.out.println("Input: Java/res/txt_files/32Kints.txt");
        System.out.println("Output: Java/src/xairaven/ua/main/Sorting/result/" + sort.toLowerCase() + ".txt");
    }
